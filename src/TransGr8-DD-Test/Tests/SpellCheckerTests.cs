...
namespace TransGr8_DD_Test.Tests
{
    ...
    public class SpellCheckerTests
    {
        ...
        public void TestCanUserCastSpellReturnsFalseForNonExistentSpell()
        {
            // Arrange
            SpellChecker spellChecker = new SpellChecker(spells);
            string spellName = "NonExistentSpell";
        ...
        [Test]
        public void TestCanUserCastSpellReturnsTrueForSatisfiedRequirements()
        {
            // Arrange
            SpellChecker spellChecker = new SpellChecker(spells);
            string spellName = "Magic Missile";
            user.Level = 1;
            user.HasVerbalComponent = true;
            user.HasSomaticComponent = true;
        ...
        [Test]
        public void TestCanUserCastSpellReturnsFalseForPartiallySatisfiedRequirements()
        {
            // Arrange
            SpellChecker spellChecker = new SpellChecker(spells);
            string spellName = "Fireball";
            user.Level = 3;
            user.HasVerbalComponent = true;
            user.HasSomaticComponent = false;  // Fireball requires somatic component which user lacks
